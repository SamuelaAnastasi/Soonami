...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            // I Url is null then return early
            if (url == null) {
                return jsonResponse;
            }
            ...
            try {
                ...
                // If the response is successful response code is 200
                // then get the input steam and read from it
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            ...
            //if the response string is empty then return null
